...
const recipesRoute = Router()
  ...
  .post('/:recipe_id/comments', recipesController.createComment.bind(recipesController) as Application)
  .patch('/:recipe_id', recipesController.updateRecipe.bind(recipesController) as Application)
  .delete('/:recipe_id', recipesController.deleteRecipe.bind(recipesController) as Application)
